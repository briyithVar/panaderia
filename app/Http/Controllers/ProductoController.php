...
class ProductoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('productos.create',compact('categorias','provedores','personas','empresas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('productos.editar',compact('producto','categorias','provedores','personas','empresas'));
