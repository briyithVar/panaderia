                                    ...
                                    @foreach ($provedores as $provedor)
                                        @foreach ($empresas as $empresa)
                                            @if ($empresa->id==$provedor->id)
                                              <option @if ($producto->id_proveedor==$empresa->id) {{'selected'}} @endif value="{{$provedor->id}}">Empresa::{{$empresa->razonsocial}}</option>
                                            @endif
                                        @endforeach
                                        @foreach ($personas as $persona)
                                            @if ($persona->id==$provedor->id)
                                              <option @if ($producto->id_proveedor==$persona->id) {{'selected'}} @endif value="{{$provedor->id}}">Persona::{{$persona->nombre}} / {{$persona->apellidos}}</option>
                                            @endif
                                        @endforeach
                                    @endforeach
                                </select>
